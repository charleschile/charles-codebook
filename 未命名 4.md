...
create table __mo_index_secondary_index2(id int, chunk datalink, embedding vecf32(120));
...
SELECT embedding(cast('/Users/charles/Desktop/codes/testData/embeddingTest.txt' as datalink));
